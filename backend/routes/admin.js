<<<<<<< HEAD
// Admin route - import va metadata lop du lieu
...
// Admin route - kiem tra nhanh
router.get("/_ping", (req, res) => res.json({ ok: true, time: new Date() }));

// Admin route - quan ly vai tro va tai khoan
=======
const express = require("express");
const router = express.Router();
const { pool } = require("../db");
...
<<<<<<< HEAD
// Admin route - tra cuu lop va doi tuong tai nguyen
router.get(
  "/layers",
  authenticateToken,
...
<<<<<<< HEAD
// Admin route - lich su cap nhat tai nguyen
router.get(
  "/resource-history",
  authenticateToken,
  requirePerm("feature.approve"),
...
// Admin route - yeu cau duyet va chi tiet yeu cau
router.post(
  "/approval-requests",
  authenticateToken,
...
// Admin route - duyet va doi trang thai tai nguyen
router.patch(
  "/layer-objects/stage",
  authenticateToken,
  requirePerm("feature.approve"),
